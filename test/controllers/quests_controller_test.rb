...
class QuestsControllerTest < ActionController::TestCase
  ...
  test "should create quest" do
    assert_difference('Quest.count') do
      post :create, quest: { answer1: @quest.answer1, answer2: @quest.answer2, answer3: @quest.answer3, answer4: @quest.answer4, question: @quest.question, truequest: @quest.truequest }
    end
  ...
  test "should update quest" do
    patch :update, id: @quest, quest: { answer1: @quest.answer1, answer2: @quest.answer2, answer3: @quest.answer3, answer4: @quest.answer4, question: @quest.question, truequest: @quest.truequest }
    assert_redirected_to quest_path(assigns(:quest))
  end
